...
import { idlFactory } from './joinedafrica_assets.did.js';
export { idlFactory } from './joinedafrica_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.JOINEDAFRICA_ASSETS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./joinedafrica_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the joinedafrica_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./joinedafrica_assets.did.js")._SERVICE>}
 */
export const joinedafrica_assets = createActor(canisterId);
